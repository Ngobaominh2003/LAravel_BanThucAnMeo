		...
		<div class="header-main">
			...
			<div class="header-bottom">
				<div class="header-right w3agile">
                    ...
                    @csrf
						<input type="text"  value="Email" name="email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Eamil';}"/>
						...
						<p style="color: white;">Bạn chưa có tài khoản? <a href="{{ route('DangKy') }}" style="color: red;">Đăng ký ngay!</a></p>
