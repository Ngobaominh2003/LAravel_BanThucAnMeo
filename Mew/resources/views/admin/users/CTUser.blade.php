    ...
    <div class="row justify-content-center">
        <div class="col-lg-7">
            <div style="padding: 40px;">
                ...
                @if($user->avatar)
                    <img src="{{ asset('img/' . $user->avatar) }}" alt="User Avatar" class="rounded-circle user-avatar">
                @else
                    <!-- Nếu người dùng không có avatar, bạn có thể hiển thị một hình ảnh mặc định hoặc thông báo rằng họ không có avatar -->
