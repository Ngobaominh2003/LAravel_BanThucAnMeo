        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light" style="margin-bottom: 15px;">
                    ...
                    <a class="breadcrumb-item text-dark" href="#">Sửa thông tin</a>
                </nav>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-7">
            <form action="{{ route('admin.update', ['user' => $user->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div style="padding: 20px;">
                    <!-- Bỏ phần nhập ID, không cần thiết -->
                    <label for="name" style="margin-top:30px"><span class="required" style="color: red;">*</span>&nbsp;Tên tài khoản:</label>
                    <input type="text" name="name" class="form-pay-no-change-pass-w input-change-pass-w-49" style="margin-left: 44px;" placeholder="Nhập tên tài khoản..." value="{{ $user->name }}" required /><br>
                    
                    <label for="email" style="margin-top:30px"><span class="required" style="color: red;">*</span>&nbsp;Email:</label>
                    <input type="email" name="email" class="form-pay-no-change-pass-w input-change-pass-w-49" style="margin-left: 81px;" placeholder="Nhập địa chỉ email..." value="{{ $user->email }}" required /><br>
                    
                    <label for="password" style="margin-top:30px"><span class="required" style="color: red;">*</span>&nbsp;Mật khẩu:</label>
                    <input type="password" name="password" class="form-pay-no-change-pass-w input-change-pass-w-49" style="margin-left: 81px;" placeholder="Nhập mật khẩu..." required /><br>
                    
                    <!-- Thêm các trường mới -->
                    <label for="phone_number" style="margin-top:30px">Số điện thoại:</label>
                    <input type="text" name="phone_number" class="form-pay-no-change-pass-w input-change-pass-w-49" style="margin-left: 55px;" placeholder="Nhập số điện thoại..." value="{{ $user->phone_number }}" /><br>
                    
                    <label for="address" style="margin-top:30px">Địa chỉ:</label>
                    <input type="text" name="address" class="form-pay-no-change-pass-w input-change-pass-w-49" style="margin-left: 95px;" placeholder="Nhập địa chỉ..." value="{{ $user->address }}" /><br>
                    ...
                    <!-- Thêm trường để tải lên ảnh đại diện mới -->
                    <label for="avatar" style="margin-top:30px">Ảnh đại diện mới:</label>
                ...
                <div class="row px-xl-5" style="float:right;margin-right: 7rem;">
                    <button type="submit" class="btn btn-buy-outline">Cập nhật người dùng</button>
