    ...
    <div class="container-fluid pt-5 pb-3">
        <div class="row">
            <div class="col-lg-6" style="position:initial;">
                <h2 class="section-title text-uppercase mx-xl-5 mb-4"><span class="pr-3" style="border-bottom: 2px solid #F27927;color: #F27927;">Đơn hàng chờ xác nhận</span><span class="header-cart">+9</span></h2>
            </div>
            <div class="col-lg-6">
                <span style="float:right;margin-right: 3rem !important;color: #F27927;"><a href="DetailOrder.html" style="color: #F27927;">Xem tất cả >></a></span>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-7">
    ...
    <tr style="background-color: #EAEAEA; padding-top: 10px;">
        <td class="padding_table_left">
            <div class="d-flex" style="margin-top:17px">
                <div>
                    <!-- Hiển thị ảnh đại diện của người đặt hàng -->
                    <img src="{{ asset('img/' . $order->user->avatar) }}"  width="24" height="24" />
                </div>
                <div style="margin-left: 10px;">
                    <p class="title-reisgn">{{ $order->user->name }}</p>
                </div>
            </div>
        </td>
        ...
        <td class="padding-table-right">
            <small>Mã đơn hàng: {{ $order->order_id }}</small>
        </td>
    </tr>
    <tr style="border: 1px solid #D9D9D9;">
        <td>
            <!-- Hiển thị thông tin sản phẩm của đơn hàng -->
        ...
        <td>
            ...
            <p>{{ number_format($order->tong_gia, 0, ',', '.') }} VND</p>
            <small>{{ $order->phuong_thuc_thanh_toan }}</small>
        </td>
        <td>
            <!-- Hiển thị trạng thái của đơn hàng -->
            <p>{{ $order->trang_thai }}</p>
        </td>
        <td>
            <div class="d-flex">
                <a href="{{ route('print.invoice', $order->order_id) }}" class="btn btn-success">Xác nhận đơn hàng</a>
                <small style="margin-right: 5px;margin-left: 5px; margin-top: 4px;">hoặc</small>
                <form action="{{ route('donhang.destroy', $order->order_id) }}" method="POST">
                @csrf
                @method('DELETE')
...
<!--Tất cả đơn hàng-->
        <div class="row">
            <div class="col-lg-6" style="position:initial;">
                <h2 class="section-title text-uppercase mx-xl-5 mb-4"><span class="pr-3" style="border-bottom: 2px solid #F27927;color: #F27927;">Tất cả đơn hàng</span><span class="header-cart">+9</span></h2>
            </div>
            <div class="col-lg-6">
