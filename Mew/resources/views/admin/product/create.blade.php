        ...
        <div class="col-lg-7">
            <form method="POST" action="{{ route('admin.product.store') }}" enctype="multipart/form-data">
                ...
                <div style="padding: 20px;">
                    ...
                    <input type="text" id="name" name="ten_san_pham" style="margin-left: 20px;width: 60%;height: 40px;" class="form-pay-no-change-pass" placeholder="Nhập tên sản phẩm..." value="{{ old('ten_san_pham') }}" /><br/>
                    <div class="d-flex">
                        <label for="category" style="margin-top:30px"> <span class="required" style="color: red;">*</span>&nbsp;Danh mục sản phẩm:</label>
                        <input type="text" id="category" name="loai_id" class="form-pay-no-change-pass-w input-change-pass-w-49" placeholder="Nhập danh mục sản phẩm..." value="{{ old('loai_id') }}" />
                    </div><br/>
                    <div class="d-flex">
                        <label for="price" style="margin-top:30px; margin-left: 120px;"> <span class="required" style="color: red;">*</span>&nbsp;Giá:</label>
                        <input type="text" id="price" name="gia" class="form-pay-no-change-pass-w input-change-pass-w-49" placeholder="Nhập giá sản phẩm..." value="{{ old('gia') }}" />
                    </div>
                    <div class="d-flex">
                        <label for="weight" style="margin-top:30px;margin-left: 60px;"> <span class="required" style="color: red;">*</span>&nbsp;Trọng lượng:</label>
                        <input type="text" id="weight" name="khoi_luong" class="form-pay-no-change-pass-w input-change-pass-w-49" placeholder="Nhập trọng lượng sản phẩm..." value="{{ old('khoi_luong') }}" />
                    </div>
                    <div class="d-flex">
                        <label for="quantity" style="margin-top:30px;margin-left: 80px;"> <span class="required" style="color: red;">*</span>&nbsp;Số lượng:</label>
                        <input type="text" id="quantity" name="so_luong" class="form-pay-no-change-pass-w input-change-pass-w-49" placeholder="Nhập số lượng sản phẩm..." value="{{ old('so_luong') }}" />
                    </div>
                    <div class="d-flex">
                    ...
                    <textarea id="description" name="mo_ta" class="input-text-add-product" placeholder="Nhập mô tả sản phẩm..." style="margin-left: 20px;">{{ old('mo_ta') }}</textarea><br/>
                </div> 
                
                <div class="row px-xl-5" style="float:right;margin-right: 7rem;">
                    <button type="submit" class="btn btn-buy-outline">Thêm sản phẩm</button>
