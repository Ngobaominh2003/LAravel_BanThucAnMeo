...
<body>
    ...
    <div class="container-fluid pt-5 pb-3">
        <div class="px-xl-5" style="padding-bottom: 2rem;">
                    ...
                    <a href="{{ route('loaisanpham.create') }}" style="color: #000;">Thêm người dùng</a>
        </div>
        ...
        @foreach ($loaisanphams as $loaisanpham)
            <tr>
                ...
                <td style="width: 100px; height: 100px;"> <!-- Adjust the width and height as needed -->
                    <img src="{{ asset('img/' . $loaisanpham->anh) }}" alt="loaisanpham Image" style="width: 100%; height: 100%;">
                </td>

                <td>
                    <a href="{{ route('admin.product', ['loai_id' => $loaisanpham->type_id]) }}">
                        <img src="{{ asset('img/icon/ctsp.png') }}" alt="Icon" style="width: 50px; height: auto;">
                    </a>
                </td>

                <td>
                    <a href="{{ route('loaisanpham.edit', ['type_id' => $loaisanpham->type_id]) }}" style="color: black;">
                ...
                <td>
                    <form id="deleteForm{{ $loaisanpham->type_id }}" action="{{ route('loaisanpham.destroy', $loaisanpham->type_id) }}" method="POST" >
                        @csrf
                        @method('DELETE')
                        <a type="button" onclick="confirmDelete(document.getElementById('deleteForm{{ $loaisanpham->type_id }}'))"><img src="{{ asset('img/icon/xoa.png') }}" alt="Icon" style="width: 50px; height: auto;"></a>
                    </form>
                </td>
            </tr>
        @endforeach
