...
<body>
   ...
   <div class="container-fluid">
    <div class="row px-xl-5">
        <div class="col-lg-7">
            <form method="POST" action="{{ route('loaisanpham.update', $loaisanpham->type_id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                <div style="padding: 20px;">
                    <label for="name" style="margin-left: 46px;"><span class="required" style="color: red;">*</span>&nbsp;Tên loại sản phẩm:</label>
                    <input type="text" id="name" name="ten_loai_san_pham" style="margin-left: 20px;width: 60%;height: 40px;" class="form-pay-no-change-pass" placeholder="Nhập tên loại sản phẩm..." value="{{ $loaisanpham->ten_loai_san_pham }}" /><br/>
                ...
                <div class="row px-xl-5" style="float:right;margin-right: 7rem;">
                    <button type="submit" class="btn btn-buy-outline">Lưu thay đổi</button>
                    <a href="#" class="btn btn-buy-outline" style="margin-left:10px">Hủy bỏ</a>
                </div>
            </form>
        </div>
    </div>
