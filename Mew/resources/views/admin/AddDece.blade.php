              ...
              <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                  ...
                  <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                      <div class="navbar-nav mr-auto py-0">
                          ...
                          <a href="ManagerDece.html" class="nav-item nav-link active">PHÂN QUYỀN</a>
  ...
  <!-- Navbar End -->
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light" style="margin-bottom: 15px;">
                    ...
                    <a class="breadcrumb-item text-dark" href="#">Thêm sửa phân quyền</a>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        <div class="px-xl-5" style="padding-bottom: 2rem;">
          <label for="name" style="font-weight: 700;">Tên tài khoản:</label>
          <input type="text" style="margin-left: 20px;" class="form-pay-no-change-pass" /></br>
        </div>
       <div class="row px-xl-5">
        <table border="1">
            <tr>
