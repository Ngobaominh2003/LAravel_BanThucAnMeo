...
<body>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-12">
                <p class="text-center" style="color:#F27927;font-weight: 400;font-size: 35px;">Bạn đã đặt hàng thành công!!!</p>
                <p class="text-center" style="color: #000;"><a href="/" style="color: #000;border-bottom: #000;">Đăng nhập</a> với thông tin người nhận hàng để theo dõi đơn hàng của bạn</p>
            </div>
        </div>
